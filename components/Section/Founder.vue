...
<template>
  <section data-fade="left" id="career" class="relative z-4 mb-0 mt-[-70px] h-auto min-h-[650px] w-full overflow-hidden rounded-tl-none text-white lg:mb-[-299px] lg:mt-[-299px] lg:h-[598px] lg:min-h-0 lg:w-[90.28%] rounded-[50px]">
