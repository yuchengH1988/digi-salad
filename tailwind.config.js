...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        'mb/display/1': ['30px', { lineHeight: '1.8', letterSpacing: '5px', fontWeight: '700' }],
        'dt/display/1': ['38px', { lineHeight: '1.842', letterSpacing: '9.17px', fontWeight: '700' }],
        'mb/h/1': ['24px', { lineHeight: '1', letterSpacing: '3.64px', fontWeight: '700' }],
        'dt/h/1': ['28px', { lineHeight: '1', letterSpacing: '3.64px', fontWeight: '700' }],
        'mb/h/2': ['28px', { lineHeight: '1.214', letterSpacing: '3px', fontWeight: '700' }],
        'dt/h/2': ['32px', { lineHeight: '1.219', letterSpacing: '3.64px', fontWeight: '700' }],
        ...
        'mb/body/1': ['15px', { lineHeight: '1.75', letterSpacing: '0.8px', fontWeight: '400' }],
        'dt/body/1': ['16px', { lineHeight: '1.75', letterSpacing: '1px', fontWeight: '400' }],
        'mb/body/2': ['15px', { lineHeight: '1.6', letterSpacing: '0.8px', fontWeight: '400' }],
        'dt/body/2': ['16px', { lineHeight: '1.5', letterSpacing: '1px', fontWeight: '400' }],
        ...
        'mb/quote/1': ['18px', { lineHeight: '2', letterSpacing: '1.4px', fontWeight: '400' }],
        'dt/quote/1': ['22px', { lineHeight: '2.182', letterSpacing: '2px', fontWeight: '400' }],
        ...
        'sm/body/4': ['12px', { lineHeight: '1.75', letterSpacing: '0.8px', fontWeight: '400' }],
      }
    }
  },
  plugins: []
